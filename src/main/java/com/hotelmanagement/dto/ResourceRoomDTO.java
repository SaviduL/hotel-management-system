 ...
 */
public class ResourceRoomDTO implements Serializable {
    private Integer id;
    @Size(max = 50)
    @NotNull
    private String name;
    ...
    public ResourceRoomDTO(Integer id, String name, Integer roomNo, String description, String bedType, Integer noOfBed, String roomType, BigDecimal charge) {
        this.id = id;
        this.name = name;
        this.roomNo = roomNo;
    ...
    public boolean equals(Object o) {
        ...
        ResourceRoomDTO entity = (ResourceRoomDTO) o;
